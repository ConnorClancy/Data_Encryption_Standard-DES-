/*
Class handles the encryption and decryption of an given input and key.
The KEY is to be given in the form of 16 character long hexadecimal string.
The PLAIN is any plaintext string for encryption, but is used as a hexadecimal string for decryption.
Class works by converting the PLAIN into Binary blocks and running DES algorithm operations on them,
while taking the KEY and running it through the KeyScheduler class to produce 48 bit long derivations.
 */
public class DesAlgorithm {
    ...
    /*debugging help
        System.out.println(EncIn.toString());
        System.out.println("permutation: " + permute);
        System.out.println("len" + permute.length());
        System.out.println("input binary: " + inputBlock + "\nLength =" + inputBlock.length());
        String inputBlock ="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ<>";
