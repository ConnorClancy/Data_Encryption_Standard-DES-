/*
Class creates 16 48-bit keys from a 56 key input. The keys are stored in a public array allowing them to be accessed
from within the cipher function f.
This is done to guarantee the correct keys are being accessed at the right times as it provides easy and managable access
 */
class KeyScheduler {
